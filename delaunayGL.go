...
// GTK Communication
///////////////////////////////////////////////////////
var g_GTKCom chan func()
var g_GTKComClose chan int
...
// Re-render will be triggered by the gtk controls!
...
func InitializeGeoRender(communication chan func(), closingChannel chan int, pointCount int, defaultImage string) {
	var err error = nil
	...
	g_GTKCom = communication
	g_GTKComClose = closingChannel
	g_window = window
